...
$jobs = [
    ...
    [
        ...
        'title' => '建設課の受付事務スタッフ',
        'area' => 'oshidomari',
        'catch_copy' => '"利尻富士"を仰ぐ島で、暮らしも仕事もリスタート',
        'description' => "\"利尻富士\"を仰ぐ島で、暮らしも仕事もリスタート\n\nやさしい自然と人に囲まれた毎日\n\n小さな島だからこそ人のあたたかさが身近に。\n\n顔が見える距離感で、人とのつながりが自然に育まれる。「困ったときはおたがいさま」そんな空気が、日々の安心につながります。\n\nそんな、利尻富士町であなたの生活も暮らしも全面サポート。\n\n町役場の建設課にて、《土木技術職員》を募集。\n\n【具体的な業務内容】\n\n工事業者からの工事の申請対応や書類処理などの窓口業務・事務作業\n\n住民の方などのご依頼で道路や河川の維持管理や点検、補修の手配など\n\nをお任せします。\n\n\"ここで働く\"は、\"ここで暮らす\"を支えてくれる。\n\n「都会の喧騒を離れて、新しい生き方を始めたい」そんな想いを胸に抱くあなたにとって、利尻富士町はその一歩をやさしく後押ししてくれる場所。\n\n利尻富士町の行政に関わるこの仕事は雇用の安定はもちろん、「移住のサポート」「社会的な信頼」も確かなポジション。ただ働くだけでなく、\"暮らしそのもの\"をしっかりと支えてくれる安心の環境があります。\n\n移住がはじめての方も心配はいりません。\"島ぐらし\"という新しいチャレンジに、町ぐるみで寄り添ってくれる温かさがあります。\n\n土木分野を学んだあなたへ。\n\n仕事も生活も無理せず、心地よく。そんな未来を、利尻富士町ではじめてみませんか？\n\nお気軽にご連絡ください。",
    ...
    [
        ...
        'description' => "地域に根ざした看護の仕事は、毎日の出会いがあたたかく、暮らしと医療のあいだをつなぐお仕事です。\n\n利尻富士町デイサービスセンターにて、《看護スタッフ》を募集。\n\n看護業務全般（食事介助、排せつ、採血、通院付添 など）\n\n夜勤・夜間待機・介護業務サポート\n\nPCでの記録入力\n\n医師の指示に基づく処置（注射、褥瘡処置、吸引等）\n\nをお任せします。",
    ...
    [
        ...
        'area' => 'oniwaki',
        'catch_copy' => '自然のそばで、人に寄り添う介護へ。地域を支える"やさしいチカラ"求む',
        'description' => "自然のそばで、人に寄り添う介護へ。\n\n地域を支える\"やさしいチカラ\"求む。\n\n利尻富士町デイサービスセンターにて、《介護スタッフ》を募集。\n\n【具体的な業務内容】\n\n食事、入浴、排せつなど日常生活サポート\n\n着替えや移乗、シーツ交換など身体介助\n\n夜勤業務\n\nレクリエーションの実施や見守り等\n\n介護記録などシステム入力\n\nをお任せします。\n\n実務未経験の方も、気軽にご相談ください。研修・サポート体制が整備されています。",
    ...
    [
        ...
        'description' => "地域と人をつなぐ仕事。離島での直接的な人間関係の中で「誰かの役に立っている」ことを実感できる環境です。\n\n利尻富士町総合保健福祉センターにて、《ケアマネジメント担当》を募集。\n\n【具体的な業務内容】\n\n高齢者やご家族の相談対応\n\n一人ひとりに合わせたケアプランの作成\n\n地域資源やサービス事業者との連携\n\n包括支援センターの業務（介護予防・総合相談など）\n\n相談に来られる方に寄り添いながら必要な福祉サービスを組み合わせて提案する仕事です。",
    ...
    [
        ...
        'area' => 'oniwaki',
        'catch_copy' => '人のぬくもりが、仕事の原動力に。"地域の健康"を支える、離島の医療拠点',
        'description' => "人のぬくもりが、仕事の原動力に。\n\n\"地域の健康\"を支える、離島の医療拠点。\n\n年間休日125日で、暮らしもゆとりも両立。\n\n利尻富士町が運営する施設にて、《看護スタッフ》を募集。\n\n【看護業務】\n\n健康チェック・バイタル管理\n\n医師の回診補助・服薬サポート・医療処置\n\n記録や報告書類の作成・共有\n\n【介護サポート】\n\n食事・移動・排せつなどの日常介助\n\n環境整備（ベッドメイキング、レクサポート等）\n\nをお任せします。",
    ...
    [
        ...
        'description' => "利尻島老人保健施設にて、《介護スタッフ》を募集。\n\n【具体的な業務内容】\n\n食事・入浴・排せつなどの日常介助\n\n車椅子の移乗、ベッドメイキングなど身体介助\n\nレクリエーションや見守り\n\n介護記録の入力・申し送り対応\n\n資格があれば、経験は問いません。介護福祉士・実務者研修・初任者研修をお持ちの方は大歓迎。無資格者の場合は業務内容に応じて相談可能です。\n\n島での暮らしは、人のやさしさが支えになる。あなたのケアが、誰かの明日を明るくする。\n\n「安定した仕事に就きたい」「地方であたたかく暮らしたい」そんな想いを抱くあなたへ。",
    ...
    [
        ...
        'title' => 'リハビリ看護師',
        'area' => 'oniwaki',
        'catch_copy' => '島の風が、あなたの看護にやさしく寄り添う。ここ利尻富士町で、"心に灯をともす"仕事を始めませんか？',
        'description' => "島の風が、あなたの看護にやさしく寄り添う。\n\nここ利尻富士町で、\"心に灯をともす\"仕事を始めませんか？\n\n地域に暮らす高齢の方々の健康を支える《通所リハビリ》でのお仕事。\n\n【具体的な業務内容】\n\n健康チェックや服薬管理など日々のケア\n\n入浴や食事など暮らしのサポート\n\nレクリエーションや送迎時の見守り\n\n医師の指示による処置の補助や記録業務\n\n日々の小さな変化に気づき、\"あなたがいてくれてよかった\"と思ってもらえる看護です。",
    ...
    [
        ...
        'title' => 'リハビリ介護師',
        'area' => 'oniwaki',
        'catch_copy' => '暮らしも仕事も、利尻富士町らしく。「島で、あなたらしく働く」そんな選択肢も。',
        'description' => "暮らしも仕事も、利尻富士町らしく。\n\n「島で、あなたらしく働く」そんな選択肢も。\n\n時給1,600円×完全週休2日×移住サポートあり。\n\n利尻富士町が雇用する\"公的ポジション\"だから、安定した働き方、地域とのつながり、安心のサポート体制がぜんぶ、そろっています。\n\n離島ならではの移住支援や交通補助あり。新しい暮らしを、町全体で応援してくれるあたたかさ。利用者さんからの「ありがとう」が、毎日のやりがいに。\n\n【お任せするお仕事内容】\n\n利尻富士町が運営する通所リハビリ施設にて、高齢者の方々の日常を支えるサポートをお願いします。\n\n入浴・排せつ・食事などの身体介助\n\nレクリエーション対応・見守り支援\n\n送迎サポート・介護記録の入力\n\nリハビリの補助業務　など\n\nまるで\"家族\"のように寄り添いながら、利用者さまの笑顔と毎日を支えていくお仕事です。",
    ...
    [
        ...
        'title' => '施設の送迎スタッフ',
        'area' => 'oniwaki',
        'catch_copy' => '土日祝休み、シフトも相談しやすい柔軟さ。島の暮らしを、やさしく支える運転席へ。',
        'description' => "土日祝休み、シフトも相談しやすい柔軟さ。\n\n島の暮らしを、やさしく支える運転席へ。\n\n海と山に囲まれたこの島で、ご高齢の方々を、安心・安全に送り届ける《送迎スタッフ》をお任せします。\n\n必要なのは、特別な資格ではなく、「今日も元気でしたか？」と声をかけたくなるような、まっすぐな気持ち。あなたのハンドルが、人の暮らしをつなぎます。\n\n「おかえり」と「ありがとう」が行き交う毎日。島の風景と人のぬくもりに包まれながら、あなたらしい働き方、はじめてみませんか？\n\n【お仕事内容】\n\n利尻富士町が運営する通所リハビリ施設での、《送迎業務》。\n\nご利用者さまのご自宅〜施設間の送迎\n\n車両の点検・清掃など、安全運転の準備も大切なお仕事です\n\nご本人やご家族に、あたたかく声をかけるひと工夫も。\n\n「無事に着いた？」「ありがとうね」そんな日常のやりとりが、この仕事のやりがいです。",
    ...
    [
        ...
        'area' => 'oniwaki',
        'catch_copy' => '経験を活かして地域に寄り添う。《介護支援専門員（ケアマネ）》募集',
        'description' => "経験を活かして地域に寄り添う。\n\n《介護支援専門員（ケアマネ）》募集。\n\n【お仕事内容】\n\n利尻島の暮らしを支える《介護支援専門員（ケアマネ）》のお仕事です。\n\n具体的には...\n\nご利用者の状況把握・アセスメント\n\nケアプランの作成\n\n関係機関・ご家族との連絡・調整\n\nモニタリング・プランの見直し\n\n利尻富士町が運営する特別養護老人ホーム秀峰園にて、\"顔が見える支援\"ができる環境でご活躍いただけます。\n\n資格を活かした働き方ができます。\n\n島ならではの温かいコミュニティの中で、専門性を発揮しながら利用者様の生活を支えられます。",
