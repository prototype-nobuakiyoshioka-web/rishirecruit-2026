...
- 小型ボタン: sm/md、ピル状の操作: full
- 共通CTA (`components/ui/Button.tsx`): おもちゃのプレートとして角丸18px・内枠13px・厚み5px。ブルー系の面（primary `#8DCBD7` / aqua `#B2DBEA` / 旧gold `#C9E2F0`）と深海ブルーの文字に統一し、上辺のハイライトと押下時4pxの沈み込みで立体感を出す（2026-09-25）。
